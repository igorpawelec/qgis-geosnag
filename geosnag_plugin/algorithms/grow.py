...
class GrowCrownsAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return (
            ...
            "filled.</p>"
            "<p><b>Your own points work too.</b> The points can come from <i>Detect dead trees</i>, but "
            "also from a layer you clicked in QGIS or surveyed in the field: mark the trees you know, "
            "and the tool draws their crowns and measures them, as long as each point sits on its "
            "crown.</p>"
